...
from paths import GITHUB_DIR
from paths import ROOT_DIR

PLACES_PATH = os.path.join( GITHUB_DIR, 'instagram-filter-removal-pytorch')
...
def setupFilterRemoval():
    ifrnet_path = os.path.join(ROOT_DIR, "Models/ifrnet.pth")
    if not os.path.exists(ifrnet_path):
        with open(ifrnet_path, 'wb') as f:
